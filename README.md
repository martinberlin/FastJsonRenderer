...
- **Fonts** – Ubuntu40, Ubuntu30, Ubuntu20 plus Ubuntu-Regular, Ubuntu-Medium and Monospace preview options
...
|------|-----------|
| `drawString` | `x`, `y` (baseline), `string`, `font` (Ubuntu40 / Ubuntu30 / Ubuntu20 / Ubuntu-Regular / Ubuntu-Medium / Monospace), `c` |
| `fillRect` | `x`, `y`, `w`, `h`, `c` |
| `drawRect` | `x`, `y`, `w`, `h`, `c` |
